    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary-500">Legendary Portfolio</h1>
          <button 
            className="px-4 py-2 rounded-lg bg-primary-500 text-primary-foreground hover:bg-primary-600 transition-colors shadow-soft"
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center space-y-8 animate-fade-in">
          <h1 className="text-6xl font-bold bg-gradient-to-r from-primary-500 to-accent-500 bg-clip-text text-transparent">
            Welcome to Your Portfolio
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Built with Next.js, Tailwind CSS, and custom design tokens for a legendary experience.
          </p>
        </div>
